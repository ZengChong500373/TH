...
//                printBottom(TAG);
    ...
    public static void stackTraces(String tag, int methodCount, int methodOffset) {
        ...
        String level = "";
        Log.d(TAG, SPACE + tag + "--------- logStackTraces contactNext ----------");
        MyLog.writeException("--------- logStackTraces contactNext ----------");
        for (int i = methodCount; i > 0; i--) {
            ...
            MyLog.writeException(SPACE  + tag + builder.toString());
        }
        MyLog.writeException("--------- logStackTraces end ----------");
